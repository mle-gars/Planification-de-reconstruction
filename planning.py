...
class Planning:
	...
	def prepare_data(self):
		...
		for infra_id, infra_subdf in self.network_df.groupby(by="infra_id"):
			...
			dict_infrastructures[infra_id] = Infra(infra_id, length, infra_type, nb_houses)
...
if __name__ == "__main__":
	plannification_object = Planning("Planification de reconstruction /data/reseau_en_arbre.csv")
